...
class Document(db.Model):
    ...
    original_file_path = db.Column(db.String(255), nullable=True)  # 원본 파일 경로 (OCR 대상)
    ...
    created_at = db.Column(db.DateTime, default=datetime.utcnow, nullable=False)  # 시스템 등록일
